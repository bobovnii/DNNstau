...
gen_VARS = ["gen_met_pt", "Lept1Pt", "Lept2Pt", "EtaDil", "MTtot","genDzeta","dR" ,"Minv", "genMT", "MCTb", "genMT2lester", "gendMETPhiL1", "gendMETPhiL2"]
...
gen_met_trainin.train(x_gen_train, y_train, x_train, y_train)
