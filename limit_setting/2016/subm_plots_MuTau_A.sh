...
#		echo ./run_plots_newDataDriven.sh list_$lt $2 $syst >> job_${channel}_${lt}_$syst
		echo python /nfs/dust/cms/user/dydukhle/CMSSW_9_4_0_patch1/src/DesyTauAnalyses/NTupleMaker/test/run_plots_newDataDriven_new_MuTau_A.py list_$_lt $2 $syst >> job_MuTau_${channel}_${_lt}_$syst
