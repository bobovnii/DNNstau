...
void analyzer::Loop(){
	...
	TString fileinName = "/nfs/dust/cms/user/bobovnii/MVAstau/CMSSW_9_4_0_patch1/src/DesyTauAnalyses/NTupleMaker/test/CHANNELHERE/FILEIN";
	...
	{fileinName ="/nfs/dust/cms/user/bobovnii/MVAstau/CMSSW_9_4_0_patch1/src/DesyTauAnalyses/NTupleMaker/test/CHANNELHERE_"+systematic+"/FILEIN";}
...
//////////////////////////////////////////////////////////////////////////////
		...
		if (abs(etaTau1) < 1.460) tfrel = 1.17;
		if (abs(etaTau1) > 1.558) tfrel = 1.25;

		if (abs(etaTau1) < 0.4) tfrmu = 1.17;
		if (abs(etaTau1) < 0.8 && abs(etaTau1) > 0.4) tfrmu = 1.29;
		if (abs(etaTau1) < 1.2 && abs(etaTau1) > 0.8) tfrmu = 1.14;
		if (abs(etaTau1) < 1.7 && abs(etaTau1) > 1.7) tfrmu = 0.93;
		if (abs(etaTau1) < 2.3 && abs(etaTau1) > 2.3) tfrmu = 1.61;
