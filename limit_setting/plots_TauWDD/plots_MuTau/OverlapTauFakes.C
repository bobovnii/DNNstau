...
void OverlapTauFakes(string syst="Nominal")
{
	...
	while(std::getline(ifs, line)) // read one line from ifs
	{
		...
		if (std::string::npos != dataname.find("Single") && !(syst=="Nominal" || syst=="JetEnUp" || syst=="JetEnDown" || syst=="ElEnUp" || syst=="ElEnDown" || syst=="MuEnUp" || syst=="MuEnDown" || syst=="UnclEnUp" || syst=="UnclEnDown" )) titles.push_back(dataname+"_B_OS_Nominal_A.root");
	...
	string np_title = titles[0];
				...
				if (s_!="Nominal") app_="_"+s_;
					...
					WInclname = "WJetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_B_OS_Nominal_A.root";
					W1Jname = "W1JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_B_OS_Nominal_A.root";
					W2Jname = "W2JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_B_OS_Nominal_A.root";
					W3Jname = "W3JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_B_OS_Nominal_A.root";
					W4Jname = "W4JetsToLNu_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_B_OS_Nominal_A.root";

					DYInclname = "DYJetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_B_OS_Nominal_A.root";
					DY1Jname = "DY1JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_B_OS_Nominal_A.root";
					DY2Jname = "DY2JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_B_OS_Nominal_A.root";
					DY3Jname = "DY3JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_B_OS_Nominal_A.root";
					DY4Jname = "DY4JetsToLL_M-50_TuneCUETP8M1_13TeV-madgraphMLM-pythia8"+app_+"_B_OS_Nominal_A.root";
