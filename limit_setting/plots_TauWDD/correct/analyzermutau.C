...
void analyzer::Loop(){
	...
	TString fileinName = "/nfs/dust/cms/user/bobovnii/MVAstau/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test/CHANNELHERE/FILEIN";
	...
	{fileinName ="/nfs/dust/cms/user/bobovnii/MVAstau/CMSSW_8_0_25/src/DesyTauAnalyses/NTupleMaker/test/CHANNELHERE_"+systematic+"/FILEIN";}
...
if (retval>0.6)			FillHists(iCut, all_weights, ElV, MuV, TauV,JetsMV, METV, ChiMass,mIntermediate, Channel, muon_index,electron_index,taus_index,isSignal);
if (retval>0.6)			CFCounter[iCut]+= all_weights;
if (retval>0.6)			CFCounter_[iCut]+= all_weights;
                iCFCounter[iCut]++;
		iCut++;
