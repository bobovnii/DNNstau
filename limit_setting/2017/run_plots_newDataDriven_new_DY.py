...
for i in range(len(content)):
    ...
    try:
            ...
            pass
    working_dir = "dir_{0}_DY_{2}".format(fileB, channel, syst)
    print(" ")
    ...
    os.system("cp {0}/analyzer_DY_h {0}/{1}/analyzer.h".format(dir, working_dir))
    os.system("cp {0}/analyzer_DY_C {0}/{2}/analyzer.C".format(dir, channel, working_dir))
    os.system("cp {0}/runme.C {0}/{1}/.".format(dir,working_dir))
    os.system("cp {0}/plots_DY.h {0}/{1}/plots.h".format(dir, working_dir))
